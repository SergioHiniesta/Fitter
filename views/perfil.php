    ...
    <div class="row flex-nowrap">
      ...
      <div class="col">
        <div class="row">
          ...
          <h1 class="text-secondary pt-3" for="">Perfil</h1>
          <div class="row">
        ...
        <div class="row mt-3 mb-4">
          ...
          <div class="col-lg-8 mt-4 px-3">
            <div class="row">
              ...
              <br />
              <p class="mt-2" style="max-width: 500px">
                <?php print($perfil["descripcion"]) ?>
              </p>
            </div>
            <div class="row ">
            <a class="btn btn-secondary m-3 w-25" href="../controller/eventosUsuarioController.php?usuario=<?php print($perfil["nombrePerfil"]) ?>" role="button">Eventos</a>
            </div> 
          </div>
        </div>
