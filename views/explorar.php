...
<body>
  <div class="container-fluid">
    <div class="row flex-nowrap">
      ...
      <div class="col">
        <h1 class="text-secondary pt-3" for="">Explorar</h1>
        <div class="row">
          <hr class="separadorTitulo">
        </div>
        <div class="row my-3 mx-1">
          <div class="col-lg-8">
            <h3 for="" class="">Aquí podrás encontrar a tus amigos</h3>
            <div class="input-group rounded">

              <input type="search" id="busqueda" class="form-control rounded" placeholder="Búsqueda" aria-label="Search" aria-describedby="search-addon" />

            </div>

            <ul id="usuarios" class="d-flex align-items-center flex-column py-5 mx-3" style="padding-left: 0">
    ...
    $(document).ready(function() {
      $("#busqueda").keypress(function() {
        $.ajax({
          method: 'POST',
          type: 'POST',
          url: '../services/buscarUsuarios.php',
          data: {
            nombre: $("#busqueda").val(),
          },
